 ...
 */
export declare const dispatchAdapter: (postRobot: typeof PostRobot) => (config: AxiosRequestConfig) => Promise<unknown>;
/**
 ...
 */
export declare const dispatchApiRequest: (url: string, options?: RequestInit | undefined) => Promise<Response>;
